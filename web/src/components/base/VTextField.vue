<template>
  <div class="text-field-wrapper">
    <div
class="v-text-field"
      :class="{ 'error': error, 'focused': isFocused, 'filled': modelValue, 'is-textarea': type === 'textarea' }">
      <div class="field-container">
        <div v-if="$slots.prefix" class="prefix">
          <slot name="prefix"></slot>
        </div>
        <textarea
v-if="type === 'textarea'" ref="textareaRef" :value="modelValue" :class="inputClass" :rows="rows"
          :placeholder="placeholder" :autocomplete="autocomplete" @input="handleInput" @focus="handleFocus"
          @blur="handleBlur" @keyup.enter="$emit('keyup.enter', $event)" @paste="$emit('paste', $event)"
          @drop="$emit('drop', $event)" @dragenter="$emit('dragenter', $event)" @dragleave="$emit('dragleave', $event)"
          @keydown="$emit('keydown', $event)" />
        <input
v-else ref="inputRef" :type="type" :value="modelValue" :class="inputClass" :placeholder="placeholder"
          :autocomplete="autocomplete" @input="handleInput" @focus="handleFocus" @blur="handleBlur"
